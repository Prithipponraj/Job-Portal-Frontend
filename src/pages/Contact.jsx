    ...
    <>
      ...
      <div className="bg-gray-100 min-h-screen pt-14 md:px-20 px-3 text-black">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          ...
          <div>
            <p class="text-3xl text-blue-700">Contact Information</p>

            <Card
              title="Address"
              content="jobfinder, Wall Street, New York, 123, United States"
            />
            <Card
              title="Email"
              content={[
                "General Inquiries: info@jobfinder.com",
                "Support: support@jobfinder.com",
                "Job Applications: jobs@jobfinder.com",
              ]}
            />
            <Card
              title="Phone"
